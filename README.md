...
```yaml
    codedx-tomcat:
        image: codedx/codedx-tomcat:v2023.12.0
        environment:
...
1. Start your Code Dx Tomcat container
    ...
    If an external database install is being used (Code Dx currently requires [MariaDB version 10.6.x](https://mariadb.com/kb/en/release-notes-mariadb-106-series/)), you would instead use the command:
